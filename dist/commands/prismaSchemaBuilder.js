...
function fieldToPrismaString(fieldName, fieldConfig) {
    ...
    const typedFieldConfig = fieldConfig; // Type assertion
    let parts = [fieldName];
    ...
    if (typedFieldConfig.isId)
        parts.push('@id');
    if (typedFieldConfig.isUnique)
        parts.push('@unique');
